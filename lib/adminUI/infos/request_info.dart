...
class RequestInfo extends StatefulWidget {
  ...
  String contactnumber, address, schedule,totalLoad;
...
class _RequestInfoState extends State<RequestInfo> {
  final totalLoadTEC = TextEditingController();
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          detailText('TOTAL LOAD(MAX 8Kg/load):', widget.totalLoad, 15, 20),
        ...
        child: Column(
          children: [
                ...
                Column(
                  children: [
                    Container(
                      ...
                      height: 35,
                      child: TextFormField(
                        controller: totalLoadTEC,
                        // onChanged: (value) {
                        //   setState(() {
                        //     totalLoadValue = 0 + int.parse(value);
                        //   });
                        // },
            ...
            ElevatedButton(
                onPressed: () {
                  setState(() {
                    totalCharge.text = (int.parse(totalLoadTEC.text) *
                                int.parse(laudryCostTEC.text) +
                            int.parse(chargeTEC.text))
                        .toString();
                  });
                },
